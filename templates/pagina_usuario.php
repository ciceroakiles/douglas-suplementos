        ...
        <head>
            ...
            <script>
                window.onload = function () {
                    var janela = document.getElementById('criar_exercicio');
            ...
            <section id="criar_exercicio" style="display: none">
                ...
                <form method="post" action="">
                    <div id="semanas_janela_exercicio">
                        <input type="radio" name="semana" id="domingo" value="dom" style="width: 15px; height: 15px; margin: 5px" />
                        <label for="domingo" >Domingo</label><br />
                        <input type="radio" name="semana" id="segunda" value="seg" style="width: 15px; height: 15px; margin: 5px" />
                        <label for="segunda" >Segunda-feira</label><br />
                        <input type="radio" name="semana" id="terca" value="ter" style="width: 15px; height: 15px; margin: 5px" />
                        <label for="terca" >Terça-feira</label><br />
                        <input type="radio" name="semana" id="quarta" value="qua" style="width: 15px; height: 15px; margin: 5px" />
                        <label for="quarta" >Quarta-feira</label><br />
                    </div>

                    <div id="semanas_janela_exercicio">
                        <input type="radio" name="semana" id="quinta" value="qui" style="width: 15px; height: 15px; margin: 5px" />
                        <label for="quinta" >Quinta_feira</label><br />
                        <input type="radio" name="semana" id="sexta" value="sex" style="width: 15px; height: 15px; margin: 5px" />
                        <label for="sexta" >Sexta-feira</label><br />
                        <input type="radio" name="semana" id="sabado" value="sab" style="width: 15px; height: 15px; margin: 5px" />
